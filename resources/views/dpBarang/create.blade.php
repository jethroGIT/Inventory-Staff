...
<body>
    <div class="container">
        <div class="form-container mx-auto">
            <h1 class="form-title">Detail Peminjaman Barang</h1>
            <form action="{{ url('peminjaman-barang/dp/store') }}" method="POST">
                @csrf
                <div class="mb-3">
                    <label for="no_kop" class="form-label">No Kop:</label>
                    <input type="text" class="form-control" id="No_kop" name="No_kop" value="{{ $noKop }}" readonly>
                </div>
                
                <!-- Dynamic Table for Details -->
                <table class="table table-bordered">
                    ...
                    <tbody id="details-table">
                        <tr>
                            <td><input type="text" class="form-control" name="No_inventaris[]" required></td>
