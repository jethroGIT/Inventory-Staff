...
@section('content')
    <h1 class="text-3xl text-center font-bold text-dark mb-2">List Surat Peminjaman Barang</h1>
    ...
    <a href="{{ url('peminjaman-barang/create') }}" class="btn btn-primary mb-1">Tambah Item</a>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ url('peminjaman-barang/'.$peminjaman->No_kop.'/view') }}">view</a>
                        <a href="{{ url('peminjaman-barang/'.$peminjaman->No_kop.'/edit') }}"> | edit | </a>
                        <a href="{{ url('peminjaman-barang/'.$peminjaman->No_kop.'/destroy') }}">delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
